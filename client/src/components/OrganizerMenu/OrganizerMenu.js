...
import { getOrgRoomById, editAskStatus, orgRoomUnload,editFeedbackStatus } from "../../actions/orgRoomActions";
...
export default connect(mapStateToProps,{getOrgRoomById,editAskStatus,orgRoomUnload,editFeedbackStatus})(OrganizerMenu) ;
