            ...
            <form onSubmit={handleSubmit}>
                ...
                <Row className='mt-2'>
                    <Col xs='12' className='p-2'>
                        <input className='askText' type='text'
                            name='text'
                ...
                <Row>
                    <Col xs='6' className='text-left mt-2'>
                        <div className="custom-control custom-switch text-left ">
                            ...
                            <label className="custom-control-label anonymous" htmlFor="anonymousSwitch">Send as Anonymous</label>
                        </div>
                    </Col>
                    <Col xs='6' className='text-right mt-2'><button type='submit' className='btnAdvance' ><img src={sent}></img></button></Col>
